...
window.DLFORECAST = (function () {
  ...
  function paintCoin(el, c, days) {
    ...
    el.innerHTML = '<div class="h">🎯 Forecast Journal <span style="font:500 11px var(--cmc-sans,sans-serif);color:var(--muted)">· you get graded, not the crowd</span><span class="sp"></span><span class="dl-chips" style="margin:0"><button class="dl-chip' + (days === 7 ? " on" : "") + '" data-h="7">7d</button><button class="dl-chip' + (days === 30 ? " on" : "") + '" data-h="30">30d</button></span></div>' +
