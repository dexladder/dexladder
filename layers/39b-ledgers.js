...
window.DLLEDGERS = (function () {
  ...
  function basketIndex(b) { var v = 0; b.legs.forEach(function (l) { var c = C.coin(l.sym); if (c && c.price) v += l.w * c.price / l.px0; }); return v * 100; }
