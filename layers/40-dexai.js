...
window.DEXAI = (function () {
  ...
  function coachSheet() {
    C.open("dlCoach", { title: "✦ DeXaI Coach", sub: "your journal, tagged and scored — one thing to fix at a time", tabs: [["review", "Review"], ["tags", "Tags"], ["how", "How it judges"]], onTab: function (t, body) {
      ...
      body.innerHTML = '<div class="dl154"><div class="h">One thing to fix</div><p class="why" style="font:600 14px var(--cmc-sans,sans-serif);color:#eaf2ff;margin:4px 0 8px">' + esc(r.fix) + "</p>" + (r.fixes.length > 1 ? '<div class="n">Next: ' + esc(r.fixes[1].t) + "</div>" : "") + "</div>" +
