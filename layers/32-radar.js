...
window.DLRADAR = (function () {
  ...
  function sandboxHTML(p) {
    ...
    return '<div class="dl154" id="dlRdSand"><div class="h">🧪 Practise this pool ' + C.simTag() + '<span class="sp"></span><span style="font:600 11.5px var(--cmc-sans,sans-serif);color:var(--muted)">pool book <b id="dlRdCash">' + C.money(B.cash, 2) + "</b> paper USDT</span></div>" +
